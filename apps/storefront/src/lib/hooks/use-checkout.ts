  ...
  return useMutation({
    mutationFn: async (formData: FormData) => {
      ...
      const billingAddress = {
        ...
        address_2: (data["billing_address.address_2"] as string) || undefined,
        company: (data["billing_address.company"] as string) || undefined,
        ...
        province: (data["billing_address.province"] as string) || undefined,
        phone: (data["billing_address.phone"] as string) || undefined,
      }
