...
const CHECKOUT_CART_FIELDS =
  "id, *items, *items.product, *items.variant, total, currency_code, subtotal, shipping_total, discount_total, tax_total, email, *shipping_address, *billing_address, *shipping_methods, *region, *region.countries, *payment_collection, *payment_collection.payment_sessions, *promotions"
